object Receber: TReceber
  ...
  object DateTimePicker1: TDateTimePicker
    ...
    Height = 21
    Anchors = [akTop, akRight]
    Date = 42284.053253310190000000
    Time = 42284.053253310190000000
    TabOrder = 6
  end
  ...
  object IBQueryCli: TIBQuery
    ...
    SQL.Strings = (
        ...
        'R.VALOR_JUROS,R.VALOR_TOTAL,R.VALOR_PAGO,R.REF,R.STATUS,R.ID_CAD' +
        '_FK,R.ID_OS_FK,'
      
        'C.NOME,C.TEL,C.CPF_CNPJ,C.ENDERECO,C.TIPO_CAD FROM CONTA_REC AS ' +
        'R INNER JOIN PESSOA AS C'
      'ON C.ID_CAD = ID_CAD_FK')
    Left = 624
    Top = 48
    object IBQueryCliID_CONT_REC: TIntegerField
      FieldName = 'ID_CONT_REC'
      Origin = '"CONTA_REC"."ID_CONT_REC"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object IBQueryCliDATA_LANC: TDateField
      FieldName = 'DATA_LANC'
      Origin = '"CONTA_REC"."DATA_LANC"'
    end
    object IBQueryCliDATA_ABERT: TDateField
      FieldName = 'DATA_ABERT'
      Origin = '"CONTA_REC"."DATA_ABERT"'
    end
    object IBQueryCliDATA_VENC: TDateField
      FieldName = 'DATA_VENC'
      Origin = '"CONTA_REC"."DATA_VENC"'
    end
    object IBQueryCliDATA_PAG: TDateField
      FieldName = 'DATA_PAG'
      Origin = '"CONTA_REC"."DATA_PAG"'
    end
    object IBQueryCliVALOR_JUROS: TIBBCDField
      FieldName = 'VALOR_JUROS'
      Origin = '"CONTA_REC"."VALOR_JUROS"'
      Precision = 9
      Size = 2
    end
    object IBQueryCliVALOR_TOTAL: TIBBCDField
      FieldName = 'VALOR_TOTAL'
      Origin = '"CONTA_REC"."VALOR_TOTAL"'
      Precision = 9
      Size = 2
    end
    object IBQueryCliVALOR_PAGO: TIBBCDField
      FieldName = 'VALOR_PAGO'
      Origin = '"CONTA_REC"."VALOR_PAGO"'
      Precision = 9
      Size = 2
    end
    object IBQueryCliREF: TIBStringField
      FieldName = 'REF'
      Origin = '"CONTA_REC"."REF"'
      Size = 30
    end
    object IBQueryCliSTATUS: TIBStringField
      FieldName = 'STATUS'
      Origin = '"CONTA_REC"."STATUS"'
      Size = 10
    end
    ...
    object IBQueryCliID_OS_FK: TIntegerField
      FieldName = 'ID_OS_FK'
      Origin = '"CONTA_REC"."ID_OS_FK"'
    end
  ...
  object DBPipelinelista: TppDBPipeline
    DataSource = DataSourcecli
    UserName = 'DBPipelinelista'
    Left = 622
    Top = 192
  end
  object ppReportlista1: TppReport
    AutoStop = False
    DataPipeline = DBPipelinelista
    ...
    Version = '16.02'
    mmColumnWidth = 0
    DataPipelineName = 'DBPipelinelista'
  ...
  object ppReportlista2: TppReport
    AutoStop = False
    DataPipeline = DBPipelinelista
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Report'
