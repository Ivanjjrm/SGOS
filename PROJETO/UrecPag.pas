...
if (ComboBox1.ItemIndex <>-1) and (Application.MessageBox('Cofirma a data de Pagamento?','Atenção Usuário',MB_YESNO+MB_ICONQUESTION)=6) then
begin
IBQueryPag.Close;
IBQueryPag.SQL.Text:='UPDATE CONTA_PAG SET'+
' DATA_PAG=:dataPag,JUROS=:juros,VALOR_PAGO=:total,STATUS=:status'+
...
IBQueryPag.Close;
IBQueryPag.SQL.Text:='INSERT INTO MOV_FINAN (ID_MOV,DATA_MOV,ORIGEM,TIPO_PAG,VALOR_MOV,HORA_MOV,ID_CONT_PAG)'+
' VALUES (:idmov,:data_mov,:origem,:tipo_pag,:valor,:HORA,:idcontpag)';
