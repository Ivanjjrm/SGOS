...
if (Enome.Text <> '') and (Efantasia.Text <> '') and (Application.MessageBox('Deseja Alterar Configurações','Atenção Usuário',MB_YESNO+MB_ICONQUESTION)=6) then
begin
...
Form1.IBQueryConfg_CPF.ParamByName('email').AsString:=Eemail.Text;
Form1.IBQueryConfg_CPF.ParamByName('carencia').AsString:=Ecarencia.Text;
Form1.IBQueryConfg_CPF.ExecSQL;
 Form1.IBQueryConfg_CPF.Open;
 Form1.IBQueryConfg_CPF.Active:=true;
close;
end;
end;
