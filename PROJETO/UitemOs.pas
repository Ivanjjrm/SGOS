...
begin
Application.MessageBox('Selecione Um serviço!','Erro',MB_ICONERROR);
...
if (Application.MessageBox('Deseja Realmente Excluir?','Atenção Usuário',MB_YESNO+MB_ICONQUESTION)=6) then
begin
IBQueryLanc.Close;
...
Verif:='false';
          ...
          begin
          Application.MessageBox('Aida Existe Equipamentos sem serviço!','Erro',MB_ICONERROR);
           end;
end;
